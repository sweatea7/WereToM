...
GENERATOR_BASE_URL = os.environ.get("GENERATOR_BASE_URL", "https://api.deepseek.com")
...
def process_one(
    ...
    if not args.dry_run:
        ...
        if generator_client is None:
            ...
            raise RuntimeError("缺少生成模型 API key。请通过环境变量 GENERATOR_API_KEY 或 --generator-api-key 传入。")
